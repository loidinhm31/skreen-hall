...
export const renderFakeApp = (blurState: ExtendedBlurState) => {
                ...
                <div style={{
                    ...
                    <div style={{display: 'flex'}}>
                        ...
                        <div style={{flex: 1, padding: '16px'}}>
                            <div><span style={{color: '#569cd6'}}>import</span> <span
                                style={{color: '#ce9178'}}>React</span> <span style={{color: '#569cd6'}}>from</span>
                                <span style={{color: '#ce9178'}}>'react'</span>;
                            </div>
                            <div><span style={{color: '#569cd6'}}>import</span> <span
                                style={{color: '#ce9178'}}>ReactDOM</span> <span style={{color: '#569cd6'}}>from</span>
                                <span style={{color: '#ce9178'}}>'react-dom/client'</span>;
                            </div>
                            <div><span style={{color: '#569cd6'}}>import</span> <span
                                style={{color: '#ce9178'}}>App</span> <span style={{color: '#569cd6'}}>from</span> <span
                                style={{color: '#ce9178'}}>'./App'</span>;
                            </div>
                            <br/>
                            <div><span style={{color: '#569cd6'}}>const</span> <span
                                style={{color: '#9cdcfe'}}>root</span> = <span
                                style={{color: '#dcdcaa'}}>ReactDOM</span>.<span
                                style={{color: '#dcdcaa'}}>createRoot</span>(
                            </div>
                            <div style={{marginLeft: '16px'}}><span style={{color: '#9cdcfe'}}>document</span>.<span
                                style={{color: '#dcdcaa'}}>getElementById</span>(<span
                                style={{color: '#ce9178'}}>'root'</span>) <span style={{color: '#569cd6'}}>as</span>
                                <span style={{color: '#4ec9b0'}}>HTMLElement</span></div>
                            <div>);</div>
                            <br/>
                            <div><span style={{color: '#9cdcfe'}}>root</span>.<span
                                style={{color: '#dcdcaa'}}>render</span>(
                            </div>
                            <div style={{marginLeft: '16px'}}>&lt;<span
                                style={{color: '#4ec9b0'}}>React.StrictMode</span>&gt;</div>
                            <div style={{marginLeft: '32px'}}>&lt;<span style={{color: '#4ec9b0'}}>App</span> /&gt;
                            </div>
                            <div style={{marginLeft: '16px'}}>&lt;/<span
                                style={{color: '#4ec9b0'}}>React.StrictMode</span>&gt;</div>
                            <div>);</div>
        ...
        case 'terminal':
            return (
                <div style={{
                    ...
                    <br/>
                    <div style={{marginBottom: '8px'}}>C:\Users\Developer&gt; <span style={{color: '#00ff00'}}>npm run build</span>
                    </div>
                    ...
                    <br/>
                    <div style={{marginBottom: '8px'}}>C:\Users\Developer&gt; <span style={{color: '#00ff00'}}>git status</span>
                    </div>
                    ...
                    <div style={{display: 'flex', height: 'calc(100% - 40px)'}}>
                        ...
                        <div style={{width: '300px', borderRight: '1px solid #ddd', background: '#fafafa'}}>
                            <div style={{padding: '16px', borderBottom: '1px solid #ddd', background: '#fff'}}>
                                ...
                                <div style={{fontSize: '12px', color: '#666', marginTop: '4px'}}>12 unread messages
                                </div>
                            </div>
                            <div>
                                <div style={{
                                    ...
                                    <div style={{fontSize: '12px', marginTop: '4px'}}>Let's schedule our weekly
                                        sync...
                                    </div>
                                </div>
                                <div style={{padding: '12px 16px', borderBottom: '1px solid #eee'}}>
                                    ...
                                    <div style={{fontSize: '12px', marginTop: '4px'}}>Please review the attached...
                                    </div>
                                </div>
                                <div style={{padding: '12px 16px', borderBottom: '1px solid #eee'}}>
                                    <div style={{fontSize: '14px', fontWeight: 'bold'}}>Client Presentation</div>
                                    <div style={{fontSize: '12px', color: '#666'}}>Mike Chen - Yesterday</div>
                                    <div style={{fontSize: '12px', marginTop: '4px'}}>Draft presentation ready for...
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div style={{flex: 1, padding: '24px', background: '#fff'}}>
                            <div style={{marginBottom: '16px'}}>
                                <div style={{fontSize: '20px', fontWeight: 'bold', marginBottom: '8px'}}>Project Update
                                    Meeting
                                </div>
                                <div style={{fontSize: '14px', color: '#666', marginBottom: '4px'}}>From: Sarah
                                    Johnson &lt;sarah.johnson@company.com&gt;</div>
                                <div style={{fontSize: '14px', color: '#666', marginBottom: '16px'}}>To: Development
                                    Team
                                </div>
                            </div>
                            <div style={{fontSize: '14px', lineHeight: '1.6'}}>
                                <p>Hi everyone,</p>
                                <p>I hope this email finds you well. I wanted to reach out to schedule our weekly
                                    project sync meeting for this week.</p>
                ...
                <div style={{width: '100%', height: '100%', background: '#ffffff'}}>
                    ...
                    <div style={{
                        ...
                        <div style={{textAlign: 'center', marginBottom: '40px'}}>
                            <h1 style={{fontSize: '24px', fontWeight: 'bold', marginBottom: '8px'}}>Digital
                                Transformation Initiative</h1>
                            <h2 style={{fontSize: '18px', color: '#666', marginBottom: '16px'}}>Project Proposal</h2>
                            <div style={{fontSize: '14px', color: '#888'}}>Prepared by: Technology Team | Date: December
                                2024
                            </div>
                        </div>
                        ...
                        <div style={{marginBottom: '24px'}}>
                            ...
                            <p style={{fontSize: '14px', lineHeight: '1.6', marginBottom: '12px'}}>
                                This document outlines our proposed digital transformation initiative aimed at
                                modernizing our core business processes and improving operational efficiency. The
                                project will focus on implementing new technologies that will enhance productivity,
                                reduce costs, and improve customer satisfaction.
                            </p>
                            <p style={{fontSize: '14px', lineHeight: '1.6', marginBottom: '12px'}}>
                                Our analysis indicates that this initiative could result in a 25% improvement in
                                operational efficiency and a projected ROI of 180% over the next three years.
                            </p>
                        </div>
                        ...
                        <div style={{marginBottom: '24px'}}>
                            ...
                            <ul style={{paddingLeft: '20px', fontSize: '14px', lineHeight: '1.6'}}>
                                ...
                                <li style={{marginBottom: '8px'}}>Implement cloud-based infrastructure for better
                                    scalability
                                </li>
                                <li style={{marginBottom: '8px'}}>Enhance data analytics capabilities</li>
                                <li style={{marginBottom: '8px'}}>Improve customer experience through digital channels
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            <h3 style={{
                                ...
                                marginBottom: '12px',
                                color: '#2b579a'
                            }}>Timeline and Budget</h3>
                            <p style={{fontSize: '14px', lineHeight: '1.6'}}>
                                The project is scheduled to begin in Q1 2025 with an estimated completion date of Q3
                                2025. Total budget requirement is $2.4M, allocated across infrastructure, software
            ...
            return (
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{color: '#4CAF50'}}>[12:34:56] System health check completed - All services
                            operational
                        </div>
                        <div style={{color: '#FF9800'}}>[12:34:45] Warning: High CPU usage detected on worker-node-3
                        </div>
