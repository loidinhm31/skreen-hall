...
const TitleChanger: React.FC = () => {
        ...
        const loadSettings = async () => {
            try {
                if (typeof chrome !== 'undefined' && chrome.storage && chrome.storage.sync) {
                    ...
                    const isEnabled = result[TITLE_STORAGE_KEYS.TITLE_ENABLED] !== undefined ? result[TITLE_STORAGE_KEYS.TITLE_ENABLED] : true;
    ...
    const exitTitleEditMode = useCallback((save: boolean = false) => {
        setTitleState(prev => {
        ...
        <>
            ...
            {showTitleChange && (
                ...
                >
                    ...
                    <div style={{ fontSize: '18px', fontWeight: 'bold', color: '#FF9800', maxWidth: '300px', wordBreak: 'break-word' }}>
                        {document.title}
                    </div>
                </div>
            )}
