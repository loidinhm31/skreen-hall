...
class PopupController {
    ...
    private async loadSettings(): Promise<void> {
        try {
            ...
            this.state = {
                blurEnabled: result[BLUR_STORAGE_KEYS.BLUR_ENABLED] !== undefined ? result[BLUR_STORAGE_KEYS.BLUR_ENABLED] : true,
                ...
                titleEnabled: result[TITLE_STORAGE_KEYS.TITLE_ENABLED] !== undefined ? result[TITLE_STORAGE_KEYS.TITLE_ENABLED] : true,
